  ...
  return (
    <div className="glass-card rounded-xl p-4">
      ...
      <div className="flex items-center gap-3">
        ...
        />
        <div
          className="w-10 h-10 rounded-xl flex items-center justify-center font-golos text-lg font-bold shrink-0"
          style={{
    ...
    <div className="space-y-5">
      ...
      {!selectedIdea ? (
        <div className="text-center py-20 text-muted-foreground">
          ...
          <p className="font-golos text-2xl font-light mb-2">Выберите идею</p>
          <p className="text-sm font-golos">Выберите идею выше для просмотра анализа</p>
        </div>
      ) : editing ? (
        <div className="space-y-4 animate-scale-in">
          <div className="flex items-center justify-between">
            <h3 className="font-golos text-xl font-semibold text-foreground">Редактирование анализа: {selectedIdea.title}</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 animate-fade-in">
          ...
          <div className="lg:col-span-1 space-y-4">
            <div className="glow-border rounded-2xl p-6 text-center">
              ...
              <h3 className="font-golos text-xl font-semibold text-foreground mb-4">{selectedIdea.title}</h3>

              {analysis ? (
                <>
                  <div
                    className="w-24 h-24 rounded-full mx-auto mb-4 flex items-center justify-center font-golos text-4xl font-bold"
                    style={{
          ...
          <div className="lg:col-span-2 space-y-4">
            {analysis ? (
                  ...
                  {METRICS.map(m => {
                    ...
                    return (
                      <div key={m.key} className="glass-card rounded-xl p-4 text-center">
                        ...
                        <div className="font-golos text-2xl font-semibold mb-0.5" style={{ color: col }}>{val}</div>
              ...
              <div className="glass-card rounded-2xl p-8 text-center">
                ...
                <p className="font-golos text-2xl font-light mb-2">Анализ не проведён</p>
