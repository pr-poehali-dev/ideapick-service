    ...
    <div className="space-y-5">
      ...
      {compareIdeas.length < 2 ? (
        <div className="text-center py-20 text-muted-foreground">
          ...
          <p className="font-cormorant text-2xl font-light mb-2">Выберите хотя бы 2 идеи</p>
            ...
            {compareIdeas.map((idea, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-cormorant text-lg font-semibold text-foreground mb-1">{idea.title}</h3>
                  <span className="text-[10px] text-muted-foreground font-golos">{idea.category}</span>
                  <div
                    className="text-4xl font-bold font-cormorant mt-3"
                    style={{ color }}
                  >
                    {idea.score}
                  </div>
