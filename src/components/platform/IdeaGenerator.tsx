...
export default function IdeaGenerator({ onAdd }: Props) {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-8">
        <h2 className="font-golos text-3xl font-light text-foreground mb-2">Новая идея</h2>
          ...
          <div className="glow-border rounded-2xl p-6">
            <div className="flex items-start justify-between mb-5">
              <div>
                ...
                <h3 className="font-golos text-2xl font-semibold text-foreground">{title}</h3>
                <p className="text-sm text-muted-foreground font-golos mt-1.5 leading-relaxed">{description}</p>
              </div>
              <div className="ml-4 text-center">
                <div
                  className="w-16 h-16 rounded-2xl flex items-center justify-center font-golos text-2xl font-bold"
                  style={{
