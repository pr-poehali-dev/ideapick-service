        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          ...
          <div className="lg:col-span-2 space-y-3">
            <div className="flex items-center justify-between mb-1">
              <h3 className="font-golos text-xl font-semibold text-foreground">Фреймворк решения</h3>
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-3 mb-4">
                    <div
                      className="w-7 h-7 rounded-lg flex items-center justify-center shrink-0 font-golos text-sm font-bold"
                      style={{
              ...
              {allAnswered ? (
                <>
                  <div className="text-center mb-4">
                    ...
                    <div className="font-golos text-3xl font-bold mb-1" style={{ color: decision.color }}>
                      {decision.label}
                    </div>
                ...
                <div className="text-center py-4">
                  ...
                  <p className="font-golos text-xl font-light text-foreground mb-1">Ваш вердикт</p>
