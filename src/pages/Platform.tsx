      ...
      `}>
        ...
        <div className="flex items-center justify-between px-5 py-5 border-b border-border">
          <div className="flex items-center gap-2">
            ...
            <span className="font-golos text-xl font-semibold">Ideapick</span>
          </div>
          <button
          ...
          <div className="grid grid-cols-3 gap-2">
            {[
              ...
              <div key={i} className="text-center py-2 rounded-xl bg-secondary">
                <div className="font-golos text-lg font-semibold text-gold-light">{s.val}</div>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="flex items-center justify-between px-6 py-4 border-b border-border bg-card/50 backdrop-blur-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-golos text-xl font-semibold leading-tight">
